...
exports.createPayPalOrder = async (req, res) => {
  ...
  try {
    ...
    // 创建PayPal订单
    console.log(`使用PayPal SDK创建订单，金额: ${paymentIntent.amount} ${paymentIntent.currency || 'USD'}`);
    ...
    request.requestBody({
      ...
      application_context: {
        return_url: `${process.env.APP_URL || 'http://localhost:3005'}/payment-success`,
        cancel_url: `${process.env.APP_URL || 'http://localhost:3005'}/payment-cancel`
      }
    });
